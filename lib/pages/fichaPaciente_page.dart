...
<<<<<<< HEAD
                            onPressed: () async {
                              var teste = await repo
                                  .achar(widget.paciente.id.toString());
                              print(teste.id_prontuario);
                              print(teste.beneficiario);
                              print(teste.data_inicio_tratamento_atual);
